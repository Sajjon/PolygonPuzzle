...
final class FallingPieceNoBoardSimpleMoveTests: TestCase {
    ...
    func testFail2() {
        XCTAssertTrue(false, "Plz fix broken commented out tests in this file...")
    }
...
//    func test_GIVEN_left_positioned_vertical_block_i_piece_with_bounding_box_1column_to_the_left_of_left_edge_WHEN_try_move_it_to_the_left_THEN_move_fails_with_error() {
//        var piece = FallingPiece(block: .iBlock, rotation: .id3π½Clockwise)
